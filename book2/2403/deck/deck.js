...
var Deck = (function () {
  ...
  function SuitName(suit) {
    ...
    return suit === 0 ? 'spades' : suit === 1 ? 'hearts' : suit === 2 ? 'diamonds' : suit === 3 ? 'clubs' : 'joker';
  }
    ...
    card: function card(_card3) {
      ...
      _card3.shuffle = function (cb) {
        ...
        _card3.animateTo({
          ...
          x: plusminus(Math.random() * 40 + 20) * ____fontSize / 11,
          y: -z,
          rot: 0
        });
        _card3.animateTo({
    ...
    card: function card(_card4) {
      ...
      _card4.poker = function (i, len, cb) {
        ...
        _card4.animateTo({
          ...
          x: Math.round((i - 2.05) * 70 * __fontSize / 11),
          y: Math.round(-110 * __fontSize / 11),
          rot: 0,
    ...
    card: function card(_card6) {
      ...
      _card6.fan = function (i, len, cb) {
        ...
        _card6.animateTo({
          ...
          x: Math.cos(deg2rad(rot - 90)) * 55 * _fontSize / 11,
          y: Math.sin(deg2rad(rot - 90)) * 55 * _fontSize / 11,
          rot: rot,
    ...
    card: function card(_card7) {
      ...
      _card7.bysuit = function (cb) {
        ...
        _card7.animateTo({
          ...
          x: -Math.round((6.75 - rank) * 8 * ___fontSize / 11),
          y: -Math.round((1.5 - suit) * 92 * ___fontSize / 11),
          rot: 0,
