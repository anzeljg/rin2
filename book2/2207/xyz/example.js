...
function view(calculatorVDom) {
    return calculatorVDom.map(function (calcVNode) {
        return dom_1.div('.app', [
            dom_1.h1(".title." + styles_1.default.title, 'Množenje matrik'),
            calcVNode,
            dom_1.h2(".footnote." + styles_1.default.footnote, [
                dom_1.a({ attrs: { href: 'https://github.com/staltz/matrixmultiplication.xyz' } }, '@andrestaltz')
            ])
        ]);
    });
}
...
var defaultState = {
    ...
    matrixA: {
        values: MatrixValues_1.default.from([[1, 2], [3, 4]]),
        editable: true,
        id: 'A',
    },
    matrixB: {
        values: MatrixValues_1.default.from([[5], [6]]),
        editable: true,
        id: 'B',
    },
    matrixC: void 0,
...
function getArrayOfButtons(state) {
    ...
    if (step === 0) {
        buttons = [
            dom_1.div(".multiply." + styles_1.default.multiplyButton, [play_1.default, 'Pomnoži'])
        ];
    }
    else if (step === 1 && !state.canInteract) {
        buttons = [
            dom_1.div(".multiply." + styles_1.default.multiplyButtonDisabled, [play_1.default, 'Pomnoži'])
        ];
    }
    else if (step >= 1 && step <= queries_1.lastCombStep(state) && state.canInteract) {
        buttons = [
            dom_1.div(".next." + styles_1.default.nextButton, [next_1.default, 'Naprej']),
            dom_1.div(".end." + styles_1.default.endButton, [end_1.default, 'Do konca']),
        ];
    }
    else if (step >= 1 && step <= queries_1.lastCombStep(state) + 1 && !state.canInteract) {
        buttons = [
            dom_1.div(".next." + styles_1.default.nextButtonDisabled, [next_1.default, 'Naprej']),
            dom_1.div(".end." + styles_1.default.endButtonDisabled, [end_1.default, 'Do konca']),
        ];
    }
    else if (step === queries_1.lastCombStep(state) + 1 && state.canInteract) {
        buttons = [
            dom_1.div(".reset." + styles_1.default.resetButton, [reset_1.default, 'Ponastavi']),
        ];
    }
    return buttons;
}
...
run_1.run(main, {
    DOM: dom_1.makeDOMDriver('#matrix-container')
});
...
exports.pallete = {
    blue: '#337ab7', /*'rgb(48, 141, 255)',*/
    blueWeak: '#286090', /*'rgb(93, 166, 252)',*/
    orange: '#d9534f', /*'rgb(255, 162, 48)',*/
    orangeWeak: '#c9302c', /*'rgb(253, 180, 97)',*/
    // grayscale
    white: '#FFFFFF',
    grayLight: '#EEEEEE',
    gray: '#C5C5C5',
